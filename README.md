...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/datadeck/datadeck)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![VS Code Marketplace](https://img.shields.io/badge/VS%20Code-Marketplace-blue.svg)](https://marketplace.visualstudio.com/items?itemName=datadeck.datadeck)
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen.svg)](https://github.com/datadeck/datadeck)
...
DataDeckは、VS Code上でデータ分析の過程で生成される出力（グラフ、データフレーム、HTMLなど）を「クリップ」として保存・管理する拡張機能です。Jupyterノートブックやmarimoとの連携により、分析の試行錯誤を効率的に記録・参照できます。

## 主な機能

- **クリップ保存**: アクティブなノートブックセルの出力をワンクリックで保存
...
2. または、`.vsix`ファイルからインストール：
   ```
   code --install-extension datadeck-1.0.0.vsix
   ```
...
- **VS Code Native Notebook**: Jupyterノートブック（.ipynb）など
- **marimo**: Pythonの反応型ノートブック
